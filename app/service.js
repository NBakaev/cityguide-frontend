...
angular.module('myApp.services', ['ngRoute'])
    ...
    .service('serverRequestService', ['$q', '$http', '$rootScope', function ($q, $http, $rootScope) {
            $http.defaults.headers.common["Accept"] = "application/json";
            $http.defaults.headers.common["Content-Type"] = "application/json";

            var baseUrl = GLOBAL_CONSTANTS.SERVER_URL;
            var self = this;

            // count server connection number
            self.serversConnectionsActive = 0;
